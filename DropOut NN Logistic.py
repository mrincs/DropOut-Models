# -*- coding: utf-8 -*-
"""
Created on Tue Dec  6 19:15:02 2016
...
3 hidden layers, 1024 units each, Logistic Activation
...
class DropOut_NN_Logistic(MLPwithDropOut):
...
#                 http://www.iro.umontreal.ca/~lisa/deep/data/mnist/mnist.pkl.gz
    ...
    standard_NN_model_1 = DropOut_NN_Logistic(
            rng = rng,
            input = x,
            train_phase = train_phase
            )
