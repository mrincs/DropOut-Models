# -*- coding: utf-8 -*-
"""
Created on Sun Dec  4 13:26:24 2016

@author: mrins
"""

"""
Original Paper: Best Practices for Convolutional Neural Networks Applied to Visual Document Analysis
by Patrick Simard 2003

2 hidden layers, 800 units each, Logistic Activation
...
class Standard_NN(MLP):
    
    def __init__(self, rng, input, n_hidden):
        MLP.__init__(
            self,
            rng = rng,
            input = input,
...
def test_ANNs_onMNIST(learning_rate=0.01, L1_reg=0, L2_reg=0.0001,
...
#                 http://www.iro.umontreal.ca/~lisa/deep/data/mnist/mnist.pkl.gz
    ...
    standard_NN_model_1 = Standard_NN(
            rng = rng,
            input = x,
            n_hidden = [800, 800],
            )
